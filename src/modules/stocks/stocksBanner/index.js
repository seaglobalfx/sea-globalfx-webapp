...
const HeroImage = '/assets/images/stock-banner.png';
                    ...
                    <div className='grid-items'>
                        ...
                        >
                            ...
                            <motion.h2
                                ...
                                variants={fadeUp}
                            >
                                {t('stocksBanner.titleStart')}<span>{t('stocksBanner.titleSpan')}</span>{t('stocksBanner.titleEnd')}
                            </motion.h2>
