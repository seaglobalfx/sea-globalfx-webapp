...
export default function StocksTextContent() {
    const { t } = useLanguage();
            ...
            <div className='container-xs'>
                ...
                >
                    <motion.div className={styles.items} variants={fadeUp}>
                        ...
                        <p>
                            {t('textContent.stocks.tradingHoursDesc')}
                        </p>
                    </motion.div>
                    ...
                    <motion.div className={styles.items} variants={fadeUp}>
                        ...
                        <p>
                            {t('textContent.stocks.contractSpecsDesc1')}
                        </p>
                        <p>
                            {t('textContent.stocks.contractSpecsDesc2')}
                        </p>
                    </motion.div>
